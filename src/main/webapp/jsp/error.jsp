...
<body id="page-top" style="background-image: url(${pageContext.request.contextPath}/images/carHome.jpg);background-size: cover;">
<c:import url="${pageContext.request.contextPath}/jsp/header.jsp"/>

<div class="notification">
    <h3 class="notificationtitle">ERROR</h3>
